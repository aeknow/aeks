    ...
    <section class="sidebar">
        ...
        <li>
         ...
         <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="/goaens?gohome=gohome"><i class="fa fa-home"></i> Home</a></li>
            
            <li><a href="/newblog"><i class="glyphicon glyphicon-font"></i> Write</a></li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		   ...
		   <li><a href="/views/haeme.html"><i class="glyphicon glyphicon-th"></i> <span>Nodes Category</span></a></li>
		    ...
		    <li><a href="/views/haeme.html"><i class="fa fa-connectdevelop"></i> <span>Maerket</span></a></li>
      </ul>
