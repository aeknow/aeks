...
<td>
<input type="text"  name="keywords" placeholder="Keywords of the article" style="margin-left:10px;" value="{{.PageKeywords}}">
 <div class="checkbox">
                  <label>
...
<td>
<input type="text" name="tags" placeholder="Categories"  style="margin-left:10px;" value="{{.PageTags}}">
</td>
</tr>
...
<textarea rows="6" name="description" style="margin-left:10px;width:100%">{{.PageDescription}}</textarea>
 ...
 <input type="hidden" name="aid" value="{{.EditPath}}">
 <input type="hidden" name="lasthash" value="{{.LastHash}}">
